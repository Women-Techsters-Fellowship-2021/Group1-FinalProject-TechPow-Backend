...
namespace DonationApp.DataStore.Migrations
{
    ...
    [Migration("20210920112343_UsersUpdates")]
    partial class UsersUpdates
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DonationApp.Models.Donation", b =>
                {
                    ...
                    b.Property<string>("DoneeAppsId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("DoneeId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DonorFormsId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("DoneeAppsId");

                    b.HasIndex("DonorFormsId");
            ...
            modelBuilder.Entity("DonationApp.Models.Donation", b =>
                {
                    b.HasOne("DonationApp.Models.DoneeApplication", "DoneeApps")
                        .WithMany()
                        .HasForeignKey("DoneeAppsId");

                    b.HasOne("DonationApp.Models.DonorForm", "DonorForms")
                        .WithMany()
                        .HasForeignKey("DonorFormsId");

                    b.Navigation("DoneeApps");

                    b.Navigation("DonorForms");
                });
